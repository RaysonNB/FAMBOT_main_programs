        ...
        if step=="get_bag":
            if pose is not None:
                ...
                if cx7 == -1 and cx9 != -1:
                    ...
                    ax, ay, az = get_real_xyz(up_depth,cx5, cy5)

                    cv2.circle(show, (cx9, cy9), 5, (0, 255, 0), -1)
                    bx, by, bz = get_real_xyz(up_depth,cx9, cy9)
                    ...
                    bx, by, bz = get_real_xyz(up_depth,cx7, cy7)
                elif cx7 == -1 and cx9 == -1:
                    continue
                else:
                    cv2.circle(show, (cx7, cy7), 5, (0, 255, 0), -1)
                    ax, ay, az = get_real_xyz(up_depth,cx7, cy7)
